...
python train.py --log_dir vae_latent_beta_annealing_1 --loss_mode vae --latent_size 1024 --target_beta_val 1 --beta_mode linear
python train.py --log_dir vae_latent_beta_annealing_.8 --loss_mode vae --latent_size 1024 --target_beta_val 0.8 --beta_mode linear
python train.py --log_dir vae_latent_beta_annealing_1.2 --loss_mode vae --latent_size 1024 --target_beta_val 1.2 --beta_mode linear